defmodule HttpProxy.Utils.File do
  ...
  def get_export_binary_path(),
    do: export_path() <> "/" <> response_files()
  ...
  def get_response_path(),
    do: play_path() <> "/" <> response_files()

  @spec get_mapping_path() :: String.t
  def get_mapping_path(),
    do: play_path() <> "/" <> mapping_files()

  defp export_path(),
    do: Application.get_env(:http_proxy, :export_path, "default")
  defp play_path(),
    do: Application.get_env(:http_proxy, :play_path, "default")
  defp response_files(),
    do: %HttpProxyFile{}.response_files
  defp mapping_files(),
    do: %HttpProxyFile{}.mapping_files
  ...
  defp randam_string,
    do: Integer.to_string(:rand.uniform 100_000_000)
